  ...
  return (
    <div
      className={`
        ...
        ${hover ? "hover:shadow-xl hover:shadow-black/10 dark:hover:shadow-black/30 hover:border-white/30 dark:hover:border-zinc-600/50 hover:bg-white/70 dark:hover:bg-zinc-900/70" : ""}
